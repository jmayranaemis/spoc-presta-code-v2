...
class TvcmsSingleBlock extends Module
{
    ...
    public function createDefaultData()
    {
        ...
        foreach ($languages as $lang) {
            ...
            $result['TVCMSSINGLEBLOCK_SINGLE_BLOCK_TITLE'][$lang['id_lang']] = '<h2>LEARN TO SKATEBORAD</h2><p>Skateboarding is an action sport which involves riding and performing tricks using a skateboard. Skateboarding can also be considered a recreational activity, an art form, a job, or a method of transportation. It has been shaped along time ago.</p>';
    ...
    public function postProcess()
    {
        ...
        $languages = Language::getLanguages();
        if (Tools::isSubmit('submittvcmsSingleBlockMainTitleForm') && '0' == Tools::getValue('tvinstalldata')) {
            foreach ($languages as $lang) {
        ...
        if (Tools::isSubmit('submittvcmsSingleBlockSingleBlockForm') && '0' == Tools::getValue('tvinstalldata')) {
            foreach ($languages as $lang) {
