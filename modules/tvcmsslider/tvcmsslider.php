    ...
    public function createDefaultData()
    {
        ...
        for ($i = 1; $i <= 2; ++$i) {
            ...
            foreach ($languages as $language) {
                $slide->title[$language['id_lang']] = 'Best Quality';
                $slide->description[$language['id_lang']] = '<h2>20% Off On Product</h2><p>Our Main Goal Is To Sell The Highest Quality Goods At The Most Affordable Prices Possible</p>';
