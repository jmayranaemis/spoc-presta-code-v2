                    ...
                    <div id='tvmain-slider' class="owl-theme owl-carousel tvcms-hide-owl" {if !empty($data[0]['width']) && !empty($data[0]['height'])} style="aspect-ratio: {$data[0]['width']/$data[0]['height']}; height:{$data[0]['height']};"{/if}>
                        ...
                        {if $slide["ivr_value"] == "image_upload"}
                            ...
                            <picture>
                                ...
                                {* Default large *}
                                <img class="tvmain-slider-img tv-img-responsive" src='{$slide["image_url"]}' alt='{l s="Main Slider" mod="tvcmsslider"}' {* title='#tvmain-slider-img-{$i}' *} data-caption-id='tvmain-slider-img-{$i}' width="{$slide['width']}" height="{$slide['height']}" {if $i!=0}style="display:none" loading="lazy" {/if}> 
                            </picture>
                            <div id='tvmain-slider-img-{$i}' class='tvmain-slider-content-inner {if $i == 1}active{/if} {$slide["class_name"]}'>
                                <div class='tvmain-slider-contant'>
                                    ...
                                    <div class="tvmain-slider-btn">
                                        <button class="btn btn-primary tvall-inner-btn tvmain-slider-button animated"><span>{$slide['btn_caption']}</span>{*<i class="material-icons">arrow_forward</i>*}</button>
                                    </div>
                                    {/if}
                                </div>
                            </div>
