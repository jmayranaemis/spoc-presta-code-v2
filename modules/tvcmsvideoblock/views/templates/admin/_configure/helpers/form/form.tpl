...
{if $input.type == 'BtnInstallData'}
            ...
            <button class="btn btn-primary tvcms-sample-install-btn" type="submit" onclick="return confirmAction()" name="submitTvcmsSampleinstall">{l s='Install Sample Data' mod="tvcmsvideoblock"}</button>
    {/if}
        ...
        <div class="col-lg-9">
            <div class="form-group">
                <div class="col-lg-9">
                    <div class="dummyfile input-group">
                        <input id="{$input.name|escape:'htmlall':'UTF-8'}" type="file" name="TVCMSVIDEOBLOCK_VIDEO_IMG" class="hide-file-upload" />
                        ...
                        <span class="input-group-btn">
                            <button id="{$input.name|escape:'htmlall':'UTF-8'}-selectbutton" type="button" name="submitAddAttachments" class="btn btn-default">
                                <i class="icon-folder-open"></i> {l s='Choose a file' mod='tvcmsvideoblock'}
                            </button>
                        </span>
                    </div>
                </div>
            ...
            <div class="form-group">
                <img src="{$path|escape:'htmlall':'UTF-8'}{$fields_value[$input.name]|escape:'htmlall':'UTF-8'}" class="img-thumbnail"/>
                 <p class="help-block">{l s='Please Select Image.' mod='tvcmsvideoblock'} (Size:- {$width|escape:'htmlall':'UTF-8'} X {$height|escape:'htmlall':'UTF-8'} )</p>
            </div>
            <script>
