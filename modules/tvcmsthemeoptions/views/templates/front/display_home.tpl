                        ...
                        <tr class="tvselect-theme tvall-theme-content">
                            <td>
                                ...
                                <div class="radio-toolbar tvselect-theme-select" id="select_theme">
                                    ...
                                    <label for="radioTheme1" class="theme-1">
                                        <span>
                                            <svg class="primary-color" version="1.1" id="Layer_1" x="0px" y="0px" width="89.681px" height="47px" viewBox="0 0 89.681 47" style="enable-background:new 0 0 89.681 47;" xml:space="preserve">
                                                <g>
                                                    <polygon style="fill:#db1212;" points="0,0 0,47 64.234,47 89.681,0  " />
                                                </g>
                                            </svg>
                                            <svg class="secondary-color" version="1.1" id="Layer_1" x="0px" y="0px" width="89.681px" height="47px" viewBox="0 0 89.681 47" style="enable-background:new 0 0 89.681 47;" xml:space="preserve">
                                                <g>
                                                    <polygon style="fill:#444444;" points="89.681,0 25.445,0 0,47 89.681,47     " />
                                                </g>
                                            </svg>
                                        </span>
                                        <span class="tvtheme-label">{l s='Theme 1' d='Shop.Theme.Global'}</span>
                                    </label>
                                    <input type="radio" id="radioTheme2" name="radioTheme" data-color="#e40046" data-color-two="#ffd741" value="theme2">
                                    <label for="radioTheme2" class="theme-2">
                                        <span>
                                            <svg class="primary-color" version="1.1" id="Layer_1" x="0px" y="0px" width="89.681px" height="47px" viewBox="0 0 89.681 47" style="enable-background:new 0 0 89.681 47;" xml:space="preserve">
                                                <g>
                                                    <polygon style="fill:#e40046;" points="0,0 0,47 64.234,47 89.681,0  " />
                                                </g>
                                            </svg>
                                            <svg class="secondary-color" version="1.1" id="Layer_1" x="0px" y="0px" width="89.681px" height="47px" viewBox="0 0 89.681 47" style="enable-background:new 0 0 89.681 47;" xml:space="preserve">
                                                <g>
                                    ...
                                    <input type="radio" id="radioTheme3" name="radioTheme" data-color="#ff5805" data-color-two="#005c6e" value="theme3">
                                    <label for="radioTheme3" class="theme-3">
                                        <span>
                                            <svg class="primary-color" version="1.1" id="Layer_1" x="0px" y="0px" width="89.681px" height="47px" viewBox="0 0 89.681 47" style="enable-background:new 0 0 89.681 47;" xml:space="preserve">
                                                <g>
                                                    <polygon style="fill:#ff5805;" points="0,0 0,47 64.234,47 89.681,0  " />
                                                </g>
                                            </svg>
                                            <svg class="secondary-color" version="1.1" id="Layer_1" x="0px" y="0px" width="89.681px" height="47px" viewBox="0 0 89.681 47" style="enable-background:new 0 0 89.681 47;" xml:space="preserve">
                                                <g>
                                                    <polygon style="fill:#005c6e;" points="89.681,0 25.445,0 0,47 89.681,47     " />
                                                </g>
                                            </svg>
                                        </span>
                                        <span class="tvtheme-label">{l s='Theme 3' d='Shop.Theme.Global'}</span>
                                    </label>
                                    <input type="radio" id="radioTheme4" name="radioTheme" data-color="#0066ba" data-color-two="#e60000" value="theme4">
                                    <label for="radioTheme4" class="theme-4">
                                        <span>
                                            <svg class="primary-color" version="1.1" id="Layer_1" x="0px" y="0px" width="89.681px" height="47px" viewBox="0 0 89.681 47" style="enable-background:new 0 0 89.681 47;" xml:space="preserve">
                                                <g>
                                                    <polygon style="fill:#0066ba;" points="0,0 0,47 64.234,47 89.681,0  " />
                                                </g>
                                            </svg>
                                            <svg class="secondary-color" version="1.1" id="Layer_1" x="0px" y="0px" width="89.681px" height="47px" viewBox="0 0 89.681 47" style="enable-background:new 0 0 89.681 47;" xml:space="preserve">
                                                <g>
                                                    <polygon style="fill:#e60000;" points="89.681,0 25.445,0 0,47 89.681,47     " />
                                                </g>
                                            </svg>
                                        </span>
